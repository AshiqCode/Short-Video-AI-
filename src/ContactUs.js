            ...
            <div className="px-6 py-6">
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <a
                  ...
                  className="inline-flex w-full items-center justify-center gap-2 rounded-2xl border border-white/10 bg-slate-900/60 px-5 py-4 text-base font-semibold text-white transition hover:border-pink-400/50 hover:bg-pink-500/10 hover:text-pink-300"
                >
                  <svg
